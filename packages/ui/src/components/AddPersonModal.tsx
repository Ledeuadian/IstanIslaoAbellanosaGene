...
export function AddPersonModal({
  ...
  // Update form when default values change (e.g., when modal opens for a different parent)
  useEffect(() => {
    setFormData((prev) => ({
      ...prev,
      lastName: defaultLastName || prev.lastName,
      middleName: defaultMiddleName || prev.middleName,
    }));
  }, [defaultLastName, defaultMiddleName]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/50 pt-[10vh]">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 max-h-[85vh] overflow-y-auto">
        <div className="p-6">
